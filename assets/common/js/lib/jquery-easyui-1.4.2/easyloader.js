...
easyloader.load("menubutton")

+function($){
    var yScroll = (document.documentElement.clientHeight)-110;
    $(".exam-box").css({"height":(yScroll-70)+"px"})
    $(".container-fluid").css({"height":(yScroll)+"px"})
}(jQuery);
...
function resetbody(){
    ...
    $("body").css({"height":yScroll})
}
//function resetmenu(){
//    var yScroll = (document.documentElement.scrollHeight > document.documentElement.clientHeight) ? document.documentElement.scrollHeight : document.documentElement.clientHeight;
//    $(".cmspages-content-menu,.cmspages-content").css({"height":yScroll-120})
//}
//resetmenu()
resetbody()
